...
{
    public class AntimatterCannon : ModProjectile
    {
        ...
        public void AI()
        {
            ...
            if (projrec.Intersects(prec))
            {
                ...
                Main.player[Main.myPlayer].AddBuff(mod.BuffType("PowerfulCurseBuildup"), 3600, false); //
        ...
        public void PostDraw(SpriteBatch sp)
        {
            ...
            Texture2D MyTexture = Main.projectileTexture[mod.ProjectileType("Comet")];
