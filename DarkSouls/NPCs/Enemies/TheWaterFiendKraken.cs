...
{
    public class TheWaterFiendKraken : ModNPC
    {
        float customAi1;
        int OTimeLeft = 2000;
        ...
        {
            DisplayName.SetDefault("Kraken, the Water Fiend");
                        ...
                        if (Collision.CanHit(npc.position, npc.width, npc.height, Main.player[npc.target].position, Main.player[npc.target].width, Main.player[npc.target].height))
                        {
                            ...
                            if (Main.rand.Next(200) == 1)
                            {
                                ...
                                if (((speedX < 0f) && (npc.velocity.X < 0f)) || ((speedX > 0f) && (npc.velocity.X > 0f)))
                                {
                                    ...
                                    speedY *= num51;
                                    int damage = 70;
                                    if (Main.expertMode) { damage = 90; }
                                    int type = mod.ProjectileType("Lightning3Ball");
                                    int num54 = Projectile.NewProjectile(vector8.X, vector8.Y, speedX, speedY, type, damage, 0f, Main.myPlayer);
                                    Main.projectile[num54].timeLeft = 100;
                                    Main.projectile[num54].aiStyle = -1;
                                    customAi1 = 1f;
                            ...
                            if (Main.rand.Next(120) == 1)
                            {
                                ...
                                if (((speedX < 0f) && (npc.velocity.X < 0f)) || ((speedX > 0f) && (npc.velocity.X > 0f)))
                                {
                                    ...
                                    int damage = 40;
                                    if (Main.expertMode) { damage = 60; }
                                    int type = mod.ProjectileType("Ink");
                                    int num54 = Projectile.NewProjectile(vector8.X, vector8.Y, speedX, speedY, type, damage, 0f, Main.myPlayer);
                                    Main.projectile[num54].timeLeft = 100;
                                    Main.projectile[num54].aiStyle = -1;
                                    customAi1 = 1f;
                            ...
                            if ((Main.rand.Next(1000) == 1) || (Main.rand.Next(800) == 1 && Main.expertMode))
                            {
                                ...
                                if (((speedX < 0f) && (npc.velocity.X < 0f)) || ((speedX > 0f) && (npc.velocity.X > 0f)))
                                {
                                    ...
                                    speedY *= num51;
                                    int damage = 120;
                                    if (Main.expertMode) { damage = 150; }
                                    int type = mod.ProjectileType("TentacleSwipe");
                                    int num54 = Projectile.NewProjectile(vector8.X, vector8.Y, speedX, speedY, type, damage, 0f, Main.myPlayer);
        ...
        {
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore1"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore2"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore3"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore4"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore5"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore6"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore7"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore8"), 1.0f);
            Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/WaterFiendKrakenGore9"), 1.0f);
